<template>
    <div class="cbutton">
        <span class="tatitle">我的分享收藏</span>
    </div>
      ...
      <div class="show" v-for="data in shareFavoriteData" :key="data.id" >
        <div style="display: flex;flex-direction: column;justify-content: space-between;height: 100%;">
            ...
            <div class="more">
                ...
                <span class="text" @click="setActive(data)">进入收藏夹</span>
            </div>
        </div>
  ...
  async function getColumnShareList(currentPage) {
    try {
        ...
        const updates = response.data.data.records.map(async (favorite) => {
